...
footer.site .foot-links.sister{display:block;margin-top:16px;padding-top:14px;border-top:1px solid rgba(255,255,255,.14);font-size:.8rem;line-height:1.9}
footer.site .foot-links.sister .ja-note{display:block;opacity:.72;font-size:.75rem;margin-top:2px}
...
<p class="foot-links sister">Looking for work or study in Japan? / 仕事や学び直しを探すときは<br>
<a href="https://agent-zukan.net/" target="_blank" rel="noopener">転職エージェント図鑑</a> ・
<a href="https://freelance-anken-zukan.net/" target="_blank" rel="noopener">フリーランス案件図鑑</a> ・
<a href="https://skillup-zukan.net/" target="_blank" rel="noopener">スキルアップ図鑑</a>
<span class="ja-note">（日本語のサイトです / These sites are in Japanese）</span></p>
</div></footer>
${guideWidget()}
</body>
</html>
